...
if __name__ == '__main__':
    ...
    with pd.ExcelWriter('cluster_0.xlsx') as writer0:  
        X_cluster_0.to_excel(writer0, sheet_name='X_cluster_0')
        y_cluster_0.to_excel(writer0, sheet_name='y_cluster_0')

    # cluster 1 save 
    with pd.ExcelWriter('cluster_1.xlsx') as writer1:  
        X_cluster_1.to_excel(writer1, sheet_name='X_cluster_1')
        y_cluster_1.to_excel(writer1, sheet_name='y_cluster_1')

    # cluster 2 save 
    with pd.ExcelWriter('cluster_2.xlsx') as writer2:  
        X_cluster_2.to_excel(writer2, sheet_name='X_cluster_2')
        y_cluster_2.to_excel(writer2, sheet_name='y_cluster_2')